...
class Model:
    ...
    def __init__(self,
                 char_list: List[str]=char_list_from_file(),
                 decoder_type: int = DecoderType.BeamSearch,
                 must_restore: bool = False,
                 dump: bool = False) -> None:
        """Init model: add CNN, RNN and CTC and initialize TF."""
        self.dump = dump
        self.char_list = char_list_from_file()
        self.decoder_type = DecoderType.BeamSearch
